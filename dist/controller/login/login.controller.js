...
class UserLogin {
    static login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const validate = yield login_service_1.LoginService._userLogin(loginParams.email, loginParams.password);
    ...
    static home(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const str = yield login_service_1.LoginService._userType(parametro);
